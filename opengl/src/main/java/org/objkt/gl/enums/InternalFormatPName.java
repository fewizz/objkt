...
public enum InternalFormatPName {
	...
	public static int intMaskOf(InternalFormatPName... enums) { int i = 0; for(InternalFormatPName e : VALUES) i |= e.token; return i; }

	public static class Mask {
		static final ThreadLocal<Mask> MASKS = ThreadLocal.withInitial(() -> new Mask());
		int value;

		public static Mask of(InternalFormatPName... enums) {
			Mask m = MASKS.get();
