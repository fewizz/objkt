...
public enum UseProgramStageMask {
	...
	VERTEX_SHADER_BIT_EXT(GLConstants.GL_VERTEX_SHADER_BIT_EXT),
	FRAGMENT_SHADER_BIT_EXT(GLConstants.GL_FRAGMENT_SHADER_BIT_EXT),
	GEOMETRY_SHADER_BIT_EXT(GLConstants.GL_GEOMETRY_SHADER_BIT_EXT),
	GEOMETRY_SHADER_BIT_OES(GLConstants.GL_GEOMETRY_SHADER_BIT_OES),
	TESS_CONTROL_SHADER_BIT_EXT(GLConstants.GL_TESS_CONTROL_SHADER_BIT_EXT),
	TESS_CONTROL_SHADER_BIT_OES(GLConstants.GL_TESS_CONTROL_SHADER_BIT_OES),
	TESS_EVALUATION_SHADER_BIT_EXT(GLConstants.GL_TESS_EVALUATION_SHADER_BIT_EXT),
	TESS_EVALUATION_SHADER_BIT_OES(GLConstants.GL_TESS_EVALUATION_SHADER_BIT_OES),
	ALL_SHADER_BITS_EXT(GLConstants.GL_ALL_SHADER_BITS_EXT);
